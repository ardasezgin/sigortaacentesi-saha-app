...
describe('Storage Service', () => {
  ...
  describe('Agency Operations', () => {
    ...
    it('should update existing agency', async () => {
      ...
      const updatedAgency = { ...sampleAgency, acenteAdi: 'Updated Acentesi' };
      await saveAgency(updatedAgency);

      const retrieved = await getAgencyByLevhaNo('T091014-SAN3');
      expect(retrieved?.acenteAdi).toBe('Updated Acentesi');
    });

    it('should save multiple agencies', async () => {
      const agencies: Agency[] = [
        sampleAgency,
        { ...sampleAgency, levhaNo: 'T091015-IST1', acenteAdi: 'Acente 2' },
        { ...sampleAgency, levhaNo: 'T091016-ANK2', acenteAdi: 'Acente 3' },
      ];
    ...
    it('should merge agencies when saving multiple', async () => {
      ...
      const newAgencies: Agency[] = [
        { ...sampleAgency, acenteAdi: 'Updated' },
        { ...sampleAgency, levhaNo: 'T091015-IST1', acenteAdi: 'New Agency' },
      ];
      ...
      expect(updated?.acenteAdi).toBe('Updated');
    });
