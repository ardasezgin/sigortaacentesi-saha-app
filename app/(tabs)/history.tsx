                    ...
                    {isExpanded && (
                      <View className="mt-4 pt-4 border-t border-border gap-3">
                        ...
                        <View className="gap-2">
                          <DetailRow
                            label="Yetkili"
                            value={log.yeniVeri.yetkiliAdiSoyadi}
                          />
                          <DetailRow
                            label="Telefon"
                          ...
                          <DetailRow
                            label="Şehir/İlçe"
                            value={`${log.yeniVeri.sehir} / ${log.yeniVeri.ilce}`}
                          />
                          <DetailRow
                            label="Vergi No"
                            value={log.yeniVeri.vergiNo}
                          />
                          <DetailRow
                            label="Durum"
                            value={log.yeniVeri.durum}
                            valueColor={
                        ...
                        {log.islemTipi === 'Güncelleme' && log.oncekiVeri && (
                          <View className="mt-4 pt-4 border-t border-border">
                            ...
                            <View className="gap-2 opacity-60">
                              {log.oncekiVeri.yetkiliAdiSoyadi && (
                                <DetailRow
                                  label="Yetkili"
                                  value={log.oncekiVeri.yetkiliAdiSoyadi}
                                />
                              )}
